 ...
 <!-- <meta name="csrf-token" content="{{ csrf_token() }}"> -->
  ...
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
    ...
    <!-- <table class="table table-bordered data-table"> -->
                ...
                $sql = mysqli_query($con, "SELECT * from chatbot_hints_eng ORDER BY id_hint ASC") or die(mysqli_error($con));
                ...
                if(mysqli_num_rows($sql) > 0){
                    ...
                    while($data = mysqli_fetch_assoc($sql)){
                        ...
                        <tr>
                            ...
                            <td>'.$data['reply'].'</td>
                            <td>
                                <a href="edit_eng.php?id='.$data['id_hint'].'" class="badge badge-warning">Edit</a>
                                <a href="hapus_eng.php?id='.$data['id_hint'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
                            </td>
                        </tr>
                        ';
                        $no++;
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="tambah_eng.php" method="POST" id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
