...
$txt='has incredible potential and will go on to exceed anything that it has';
echo("<br>".$txt."<br>");

$txt= removeCommonWords($txt);

$text = \Nadar\Stemming\Stemm::stemPhrase($txt,'en');

echo $text; // consist
// 
// $text="cats";
// // $tokens = tokenize($array_txt, \TextAnalysis\Tokenizers\PennTreeBankTokenizer::class);
// $tokens = tokenize($text);
// echo $tokens; // consist

// $text = \Nadar\Stemming\PorterStemmer::stem('consistency');
...
// // $stemmed = \Nadar\Stemming\Stemm::stem($array_txt[$i],'en');
// $stemmed = \Nadar\Stemming\PorterStemmer::stem($array_txt[$i]);

//     # code...
// echo $stemmed." ";

// }
// $stemmed = \Nadar\Stemming\Stemm::stemPhrase($txt, 'en');
//     # code...
// echo "<br>".$stemmed." ";
